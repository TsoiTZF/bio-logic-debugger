...
- **30 条关联**：包括负相关连锁、权衡关系、曲线关系，基于 GWAS/QTL 研究数据
- **7 个反模式**：高产低质陷阱、极端粒型代价、过度矮化陷阱、耐旱-高产权衡等
- **9 条约束规则**：FATAL/SEVERE/WARNING 级生理法则

### 数据来源

所有数据均有可靠来源引用：

- **IRRI（国际水稻研究所）** 稻米品质评价标准
- **中国国家标准 GB/T 17891《优质稻谷》**
- **Nature、Science 等顶级期刊文献**
- **GWAS/QTL 研究数据**
- **中国水稻研究所多年田间数据**
