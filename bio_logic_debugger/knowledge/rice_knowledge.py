"""
水稻核心知识库（Oryza sativa）

这是一个内置知识库的示例，展示如何用 Bio-Logic Debugger 的数据结构
来编码真实的生物学约束。以水稻为例，覆盖产量、品质、抗病、株型等维度。
"""
...
TRAITS = [
    ...
    Trait("rice_amylose_content", "直链淀粉含量", "稻米直链淀粉含量，影响食味", "品质", "%", (0.0, 30.0), tags=["品质", "食味"]),
    Trait("rice_gel_consistency", "胶稠度", "稻米胶稠度，影响食味口感", "品质", "mm", (30.0, 100.0), tags=["品质", "食味"]),
    ...
    Trait("rice_grain_filling_period", "灌浆期", "从抽穗到成熟的天数", "生育期", "天", (25.0, 55.0), tags=["生育期"]),
]
...
ANTI_PATTERNS = [
    ...
    AntiPattern(
        ...
        trigger_traits=["rice_grain_length", "rice_grain_width", "rice_1000_grain_weight"],
        ...
        mechanism="籽粒长度超过遗传限制后，胚乳发育过程中背部与腹部的细胞分裂不同步，导致垩白产生。",
        confidence=0.75,
        species="水稻",
    ),
    AntiPattern(
        ...
        trigger_traits=["rice_plant_height", "rice_yield_per_plant", "rice_lodging_resistance"],
        severity=ConstraintSeverity.WARNING,
        historical_examples=[
        ...
        mechanism="株高极端降低虽然增强了抗倒伏性，但同时也减少了光合作用器官的总量，限制了生物产量，进而制约经济产量。",
        confidence=0.80,
        species="水稻",
    ),
    AntiPattern(
        ...
        trigger_traits=["rice_heading_days", "rice_yield_per_plant"],
        severity=ConstraintSeverity.SEVERE,
        historical_examples=[
        ...
        mechanism="生育期=光合产物积累时间。在相同的生长速率下，积累时间越长总产量越高。这是作物生理学的基本原理。",
        confidence=0.90,
        species="水稻",
    ),
    AntiPattern(
        ...
        mechanism="每个 R 基因的维持和表达都需要消耗植物的能量和代谢资源。过多抗病基因的堆叠产生累积性的生长代价（fitness cost）。",
        confidence=0.65,
        species="水稻",
    ),
]
...
CONSTRAINTS = [
    BiologicalConstraint(
        ...
        consequence="超出茎秆力学的物理极限，倒伏风险极高。",
        confidence=0.90,
        evidence=[
